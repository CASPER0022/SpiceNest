        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex space-x-3 pt-2">
              <a href="#" className={socialIconClass}><Facebook size={18} /></a>
              <a href="#" className={socialIconClass}><Instagram size={18} /></a>
              ...
              <a href="#" className={socialIconClass}><Youtube size={18} /></a>
            </div>
          </div>
