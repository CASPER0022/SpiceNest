    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center pb-20">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight mb-6 max-w-5xl leading-tight drop-shadow-lg">
          ...
          <p className="text-base md:text-xl text-gray-200 mb-10 max-w-2xl font-medium tracking-wide drop-shadow-md">
